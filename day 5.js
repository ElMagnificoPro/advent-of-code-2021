...
function part1() {
  ...
  input.forEach(e => {
    if (e.x1 === e.x2) {
      let minY = (e.y1 < e.y2) ? e.y1 : e.y2;
      let maxY = (e.y1 > e.y2) ? e.y1 : e.y2;
    ...
    if (e.y1 === e.y2) {
      let minX = (e.x1 < e.x2) ? e.x1 : e.x2;
      let maxX = (e.x1 > e.x2) ? e.x1 : e.x2;
...
input.forEach(e => {
  ...
  let dirX = (e.x1 === e.x2) ? 0 : (e.x1 > e.x2) ? -1 : 1
  let dirY = (e.y1 === e.y2) ? 0 : (e.y1 > e.y2) ? -1 : 1
